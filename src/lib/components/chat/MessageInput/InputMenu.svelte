			...
			{#if $config?.features?.enable_onedrive_integration}
				...
				>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
						<rect width="24" height="24" rx="2" fill="#036C70" />
						<path d="M11.5 6.5C9.14911 6.5 7.19275 8.01266 6.58537 10.1245C5.11036 10.4047 4 11.6447 4 13.1379C4 14.7332 5.26827 16.2069 7.12195 16.2069H17.5C18.8807 16.2069 20 15.0876 20 13.7069C20 12.3261 18.8807 11.2069 17.5 11.2069L17.4972 11.2069C17.4772 8.59981 15.3527 6.5 11.5 6.5Z" fill="white" />
						<path d="M7 9.5L12 14.5L17 9.5" stroke="#036C70" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
					</svg>
